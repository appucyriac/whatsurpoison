  ...
  _createClass(BatchManager, [{
    ...
    value: function () {
      function getRequestContext(plugin, token) {
        return Object.assign({}, this.baseContext, this.jobContexts[token], this.pluginContexts.get(plugin));
      }
    ...
    value: function () {
      function getBatchContext(plugin) {
        return Object.assign({}, this.baseContext, this.batchContext, this.pluginContexts.get(plugin));
      }
